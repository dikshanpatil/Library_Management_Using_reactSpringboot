...
export const AddNewBook = () => {
    ...
    //functions to convert image to base 64 so taht we can save it in database
    ...
    async function submitNewBook() {
        ...
        if(authState?.isAuthenticated && title !== '' && author !== '' && category !== 'Category'
            && description !== '' && copies >= 0){
                ...
                const submitNewBookRequestResponse = await fetch (url, requestOptions);
                if(!submitNewBookRequestResponse.ok){
